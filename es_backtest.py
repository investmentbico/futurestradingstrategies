...
class ESBacktest:
    ...
    def download_data(self):
        ...
        print(f"📊 Loading local ES 2-minute data...")
...
def main():
    ...
    print("🚀 ES BACKTEST: 1 CONTRACT - LAST 3 MONTHS DATA")
    print("=" * 70)

    # Load data (last 90 days = 3 months)
    backtest = ESBacktest(symbol='ES', days=90)
    ...
    for config in configs:
        ...
        test_backtest = ESBacktest(symbol='ES', days=30)
