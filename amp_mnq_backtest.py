#!/usr/bin/env python3
"""
AMP FUTURES MNQ Backtest - Last 4 Months with Real AMP Fees
=======================================================================

This script performs backtesting of the winning MNQ strategy using AMP FUTURES
real commission rates, spreads, and slippage for the last 4 months of data.
...
Data: Last 4 months (Oct 2025 - Feb 2026)
"""
...
# =============================================================================
# DATA FILTERING - LAST 4 MONTHS
# =============================================================================

def filter_last_4_months(df: pd.DataFrame) -> pd.DataFrame:
    """Filter data to last 4 months from current date (Feb 26, 2026)"""
    current_date = pd.Timestamp('2026-02-26', tz='UTC')
    four_months_ago = current_date - pd.Timedelta(days=120)  # ~4 months
    ...
    print(f"📅 Filtered to last 4 months: {four_months_ago.date()} to {current_date.date()}")
...
def run_amp_backtest(data_file: str) -> Dict:
    """Run backtest with AMP fees and last 4 months data"""

    print("🏆 AMP FUTURES MNQ BACKTEST")
    print("=" * 50)
    print("📊 Last 4 Months | Ultra Low AMP Fees")
...
def display_results(results: Dict):
    ...
    print("=" * 60)
    print("🏆 WINNING STRATEGY | Last 4 Months | Real AMP Fees")
    print()
