...
class NQBacktest:
    ...
    def download_data(self):
        ...
        print(f"📊 Loading local NQ 2-minute data...")

        import os
        data_file = "data/nq_2min.csv"
...
def main():
    ...
    print("🚀 NQ BACKTEST: 1 CONTRACT - LAST 3 MONTHS DATA")
    print("=" * 70)

    # Load data (last 90 days = 3 months)
    backtest = NQBacktest(symbol='NQ', days=90)
    ...
    for config in configs:
        ...
        test_backtest = NQBacktest(symbol='NQ', days=30)
