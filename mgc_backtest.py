#!/usr/bin/env python3
"""
MGC Strategy Backtest with Daily Historical Data
===============================================

Backtests the trading strategy using daily MGC (Micro Gold) data.
Adapted for daily timeframe with appropriate parameters for gold futures.
"""
...
# =============================================================================
# STRATEGY PARAMETERS (Adapted for Daily MGC)
# =============================================================================
...
RISK_PARAMS = {
    'CONTRACTS': 1,
    'MAX_LOSS_TRADE': 300.0,  # Higher for gold volatility
    'HARD_STOP_DOLLARS': 300.0,  # $300 hard stop for gold
    'ATR_MULTIPLIER': 2.0,
    'ATR_PERIOD': 14,
...
class MGCBacktest:
    ...
    def download_data(self):
        ...
        print(f"📊 Loading local MGC daily data...")

        import os
        data_file = "data/mgc_daily.csv"
...
def main():
    ...
    print("🚀 MGC BACKTEST: 1 CONTRACT - DAILY DATA")
    print("=" * 70)

    # Load data (last 90 days = 3 months)
    backtest = MGCBacktest(symbol='MGC', days=90)
    ...
    configs = [
        {
            'name': 'MGC_OPTIMIZED',
            'contracts': 1,
            'hard_stop': 300,  # $300 hard stop for gold volatility
            'atr_mult': 2.0,
            'atr_period': 14,
            'tp_mult': 2.0,
            'description': 'Optimized params for MGC daily data'
        }
    ]
    ...
    for config in configs:
        ...
        test_backtest = MGCBacktest(symbol='MGC', days=30)
